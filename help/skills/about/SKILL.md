...
**Latest version endpoint:** `https://help.mctx.ai/v1.0.40`
...
mctx is a managed hosting platform for Apps for AI — free to host, production-grade infrastructure, with optional developer monetization. Connect from any AI client — Claude, ChatGPT, Cursor, VS Code, and more.
...
- "How does auto-distribution to registries work?"
...
**Getting started**
You want to host your MCP server on mctx and need to know where to begin.

- "How do I get started hosting on mctx?"
- "What do I need to deploy my first server?"
- "Is hosting free?"
